  ...
  return (
    <section className="py-12 border-y border-border/50">
      <div className="max-w-7xl mx-auto px-4">
        <p className="text-center text-xs font-bold uppercase tracking-[0.2em] text-muted-foreground/40 mb-6">
            ...
            <div key={idx} className="flex items-center justify-center py-3">
              <AnimatePresence mode="wait">
                <motion.span
                  ...
                  className="text-sm font-semibold text-muted-foreground/30 hover:text-primary transition-colors duration-200 cursor-default"
                >
                  {currentSet[idx]}
                </motion.span>
              </AnimatePresence>
